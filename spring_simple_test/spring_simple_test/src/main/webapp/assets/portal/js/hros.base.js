...
HROS.base = (function(){
	return {
		...
		*/
		init : function(){
			//初始化desk高度
			$("#desk").css({height:$(window).height()-HROS.CONFIG.headerHeight-30,top:HROS.CONFIG.headerHeight});
		...
		getSkin : function(callback){
			$.ajax({
				type : 'POST',
				url : HROS.CONFIG.basicActionUrl+'/getSkin.action',
				data : '',
