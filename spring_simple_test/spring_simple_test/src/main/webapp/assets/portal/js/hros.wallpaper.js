	...
	return {
		...
		*/
		get : function(callback){
			$.ajax({
				type : 'POST',
				url : HROS.CONFIG.basicActionUrl+'/getWallpaper.action',
				success : function(msg){
					...
					switch(data.wallpaperstate){
						case 1:
							HROS.CONFIG.wallpaper = Util.fullUrl(HROS.CONFIG.basicStaticUrl,data.url);
							HROS.CONFIG.wallpaperType = data.wallpapertype;
							HROS.CONFIG.wallpaperWidth = data.width;
							HROS.CONFIG.wallpaperHeight = data.height;
							break;
						case 2:
							HROS.CONFIG.wallpaper = Util.fullUrl(HROS.CONFIG.basicDynamicUrl,'/security/download.action?id='+data.fileId);
							HROS.CONFIG.wallpaperType = data.wallpapertype;
							HROS.CONFIG.wallpaperWidth = data.width;
							HROS.CONFIG.wallpaperHeight = data.height;
							break;
		...
		*/
		update : function(wallpaperstate, wallpapertype, wallpaper){
			$.ajax({
				type : 'POST',
				url : HROS.CONFIG.basicActionUrl+'/setWallpaper.action',
